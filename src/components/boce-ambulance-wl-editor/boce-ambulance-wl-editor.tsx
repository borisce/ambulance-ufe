...
@Component({
  tag: 'boce-ambulance-wl-editor',
  styleUrl: 'boce-ambulance-wl-editor.css',
  shadow: true,
})
export class BoceAmbulanceWlEditor {
  ...
  return (
    <Host>
      ...
      <div class="duration-slider">
        ...
        <md-slider min="2" max="45" value={this.entry?.estimatedDurationMinutes || 15} ticks labeled
            oninput={ (ev:InputEvent) => {
              if(this.entry) {
